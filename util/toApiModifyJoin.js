...
`;
        ...
        assignmentStatements += `${viewName}_Api.Modify__(info_, objid_, objversion_, attr_, 'DO');\n`;
...
export async function toApiModifyJoin(databaseFrom, databaseTo, statement, statement2, viewName, filter, logging) {
