...
assignmentStatements += whereConditions + `) LOOP \n`;
        ...
        assignmentStatements += `${viewName}_Api.Remove__(info_, rec.Objid, rec.Objversion,'DO');\n`;
...
export async function toApiRemove(databaseFrom, databaseTo, statement, viewName, filter, logging) {
